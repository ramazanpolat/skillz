...
- **croc** — send files, folders, or text between **any two computers** (no SSH
  needed) via [`croc`](https://github.com/schollz/croc): peer-to-peer,
  end-to-end encrypted through a one-time code phrase, no server and no
  accounts. See [`skills/croc/SKILL.md`](skills/croc/SKILL.md).
